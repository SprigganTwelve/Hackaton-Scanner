...
const MOCK_REPORTS = [
  {
    id: "r1",
    repoUrl: "https://github.com/nodeJSexample",
    date: "2026-02-28",
    commit: "a3fe29c",
    scanId: 1,
  },
  {
    id: "r2",
    repoUrl: "https://github.com/phpExample",
    date: "2026-02-16",
    commit: "a4d6e12b",
    scanId: 2,
  },
  {
    id: "r3",
    repoUrl: "https://github.com/JavascriptExample",
    date: "2026-02-14",
    commit: "a7k4rt7v",
    scanId: 3,
  },
...
export default function ReportsPage() {
  ...
  async function onDownloadPdf(item) {
    ...
    alert(`Téléchargement PDF (mock) : ${item.repoUrl}`);
  }
